...
const Wallet = () => {
  const { user, hasPermission, userInfo } = authProvider();
  ...
  // console.log(hasPermission("admin-wallet"));
  return (
    <>
      <div className="pt-8">
        {/* {hasPermission("admin-wallet") ? <AdminWallet /> : <UserWallet />} */}
        <>
          <div>
                ...
                <>
                  <div className="flex items-center">
                    ...
                    <span className="text-green-400 text-2xl tracking-wide font-bold">
                      PKR {userBalance?.balance.toLocaleString()}
                    </span>
                  </div>
